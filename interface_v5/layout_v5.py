...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # StackedWidget for plot options
        ...
        self.repulsion_dampingLabel.setGeometry(QtCore.QRect(10, 300, 47, 13))
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(880, 40, 191, 511))
        ...
        self.ShortestPathDepthLabel = QtWidgets.QLabel(self.ShortestPath)
        self.ShortestPathDepthLabel.setGeometry(QtCore.QRect(10, 120, 111, 21))
        self.ShortestPathDepthLabel.setObjectName("ShortestPathDepthLabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Corona tracker"))
        ...
        self.repulsion_dampingLabel.setText(_translate("MainWindow", "Damping"))
        ...
        self.ShortestPathDepthLabel.setText(_translate("MainWindow", "Depth"))
        ...
        self.PlotFilterCombobox.setItemText(3, _translate("MainWindow", "Show infected nodes"))
        self.PlotFilterCombobox.setItemText(4, _translate("MainWindow", "Depth"))
    ...
    def UpdatePlotGraph(self):
        ...
        if self.PlotSelectionCombobox.currentText() == 'Hierarchical repulsion':
            ...
            if self.PlotFilterCombobox.currentText() == 'Show infected nodes':
                infected = get_infected()
            if self.PlotFilterCombobox.currentText() == 'Depth':
                source = self.DepthSource.value()
                depth = self.DepthDepth.value()
                person1, person2 = depth(self.graph, source=source, depth=depth)
